 ...
 */
export declare const describeFile: (assistantName: string, apiProvider: AsstDataOperationsProvider) => (fileId: string, includeUrl: boolean) => Promise<AssistantFileModel>;
