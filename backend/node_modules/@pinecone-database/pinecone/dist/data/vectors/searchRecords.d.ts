...
import { SearchRecordsResponse, SearchMatchTerms } from '../../pinecone-generated-ts-fetch/db_data';
/**
...
export declare class SearchRecordsCommand {
    ...
    run(searchOptions: SearchRecordsOptions): Promise<SearchRecordsResponse>;
}
