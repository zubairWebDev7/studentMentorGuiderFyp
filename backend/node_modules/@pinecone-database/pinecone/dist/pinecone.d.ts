import { CollectionName, CreateBackupOptions, CreateIndexFromBackupOptions, DeleteBackupOptions, DescribeBackupOptions, ListBackupsOptions, ListRestoreJobsOptions, CreateIndexForModelOptions, CreateIndexOptions, IndexName, DescribeRestoreJobOptions } from './control';
...
export declare class Pinecone {
    ...
    /** @hidden */
    private _createIndexFromBackup;
    /** @hidden */
    private _describeBackup;
    /** @hidden */
    private _describeRestoreJob;
    /** @hidden */
    private _deleteBackup;
    /** @hidden */
    private _listBackups;
    /** @hidden */
    private _listRestoreJobs;
    inference: Inference;
    /**
     * @example
     * ```
     ...
     */
    configureIndex(options: ConfigureIndexOptions): Promise<import("./pinecone-generated-ts-fetch/db_control").IndexModel>;
    /**
     ...
     */
    updateAssistant(options: UpdateAssistantOptions): Promise<import("./assistant").UpdateAssistantResponse>;
    /**
    ...
    evaluate(options: {
        ...
        answer: string;
        groundTruth: string;
    }): Promise<import(".").AlignmentResponse>;
    /** @internal */
     ...
     */
    createBackup(options: CreateBackupOptions): Promise<import("./pinecone-generated-ts-fetch/db_control").BackupModel>;
    /**
     ...
     */
    createIndexFromBackup(options: CreateIndexFromBackupOptions): Promise<import("./pinecone-generated-ts-fetch/db_control").CreateIndexFromBackupResponse>;
    /**
     * Describes a backup.
     *
     * @example
     ...
     * @returns A Promise that resolves to a {@link BackupModel} object.
     */
    describeBackup(backupName: DescribeBackupOptions): Promise<import("./pinecone-generated-ts-fetch/db_control").BackupModel>;
    /**
     ...
     */
    describeRestoreJob(restoreJobId: DescribeRestoreJobOptions): Promise<import("./pinecone-generated-ts-fetch/db_control").RestoreJobModel>;
    /**
     * Deletes a backup.
     *
     * @example
     ...
     */
    deleteBackup(backupName: DeleteBackupOptions): Promise<void>;
    /**
     ...
     */
    listBackups(options: ListBackupsOptions): Promise<import("./pinecone-generated-ts-fetch/db_control").BackupList>;
    /**
     ...
     * @returns A Promise that resolves to a {@link BackupList} object.
     */
    listRestoreJobs(options: ListRestoreJobsOptions): Promise<import("./pinecone-generated-ts-fetch/db_control").RestoreJobList>;
    /**
     ...
     */
    index<T extends RecordMetadata = RecordMetadata>(options: IndexOptions): Index<T>;
    /**
