...
export type { CreateAssistantOptions, UpdateAssistantOptions, UpdateAssistantResponse, AssistantList, AssistantModel, EvaluateOptions, } from './control/types';
export type { ChatOptions, ChatContextOptions, ChatCompletionOptions, ContextOptions, ListFilesOptions, UploadFileOptions, Uploadable, AssistantFilesList, MessagesModel, MessageModel, ChatModelEnum, StreamedChatResponse, StreamedChatCompletionResponse, BaseChunk, MessageStartChunk, ContentChunk, CitationChunk, MessageEndChunk, ChoiceModel, FinishReasonEnum, } from './data/types';
export type { AssistantFileModel, ChatModel, ChatCompletionModel, ContextModel, UsageModel, CitationModel, SnippetModel, TextSnippetModel, MultiModalSnippetModel, ReferenceModel, HighlightModel, } from '../pinecone-generated-ts-fetch/assistant_data';
...
export declare class Assistant {
     ...
     */
    chat(options: ChatOptions): Promise<import("../pinecone-generated-ts-fetch/assistant_data").ChatModel>;
    /**
     ...
     */
    chatCompletion(options: ChatCompletionOptions): Promise<import("../pinecone-generated-ts-fetch/assistant_data").ChatCompletionModel>;
    /**
     ...
     */
    describeFile(fileId: string, includeUrl?: boolean): Promise<import("../pinecone-generated-ts-fetch/assistant_data").AssistantFileModel>;
    /**
     ...
     */
    uploadFile(options: UploadFileOptions): Promise<import("../pinecone-generated-ts-fetch/assistant_data").AssistantFileModel>;
    /**
     ...
     */
    context(options: ContextOptions): Promise<import("../pinecone-generated-ts-fetch/assistant_data").ContextModel>;
}
