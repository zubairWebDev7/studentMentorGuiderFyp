...
exports.retryDeletes = exports.getRecordIds = exports.assertWithRetries = exports.waitUntilRecordsReady = exports.waitUntilAssistantFileReady = exports.waitUntilAssistantReady = exports.waitUntilIndexReady = exports.sleep = exports.generateMetadata = exports.generateSparseValues = exports.generateValues = exports.generateRecords = exports.randomName = exports.randomString = exports.globalNamespaceOne = exports.diffPrefix = exports.prefix = void 0;
...
const randomName = (name) => {
    return `${name}-${(0, exports.randomString)(8)}`.toLowerCase().slice(0, 45);
};
...
exports.sleep = sleep;
const waitUntilIndexReady = async (indexName) => {
...
exports.waitUntilIndexReady = waitUntilIndexReady;
const waitUntilAssistantReady = async (assistantName) => {
    const p = new index_1.Pinecone();
    const sleepIntervalMs = 1000;
    let isReady = false;
    while (!isReady) {
        try {
            ...
            throw new Error(`Error while waiting for assistant to be ready: ${error}`);
        }
    }
};
exports.waitUntilAssistantReady = waitUntilAssistantReady;
const waitUntilAssistantFileReady = async (assistantName, fileId) => {
    const p = new index_1.Pinecone();
    const sleepIntervalMs = 1000;
    let isReady = false;
    while (!isReady) {
        try {
            ...
            throw new Error(`Error while waiting for assistant file to be ready: ${error}`);
        }
    }
};
exports.waitUntilAssistantFileReady = waitUntilAssistantFileReady;
