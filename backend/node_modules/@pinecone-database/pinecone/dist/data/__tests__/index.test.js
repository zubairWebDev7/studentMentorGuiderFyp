...
describe('Index', () => {
    ...
    describe('metadata', () => {
        ...
        test('can be used without generic types param', async () => {
            const index = new index_1.Index({ name: 'index-name', namespace: 'namespace' }, config);
    ...
    describe('namespace() method', () => {
        test('creates a new Index instance targeting the specified namespace', () => {
            const index = new index_1.Index({ name: 'index-name', namespace: '__default__' }, config);
            const namespacedIndex = index.namespace('my-namespace');
            // Should be a new instance
            expect(namespacedIndex).not.toBe(index);
            expect(namespacedIndex).toBeInstanceOf(index_1.Index);
        });
        test('new instance inherits index name and config', () => {
            const index = new index_1.Index({ name: 'test-index', namespace: '__default__' }, config);
            ...
            expect(vectorOperationsProvider_1.VectorOperationsProvider).toHaveBeenCalledWith(config, 'test-index', undefined, undefined);
        });
        ...
        test('allows method chaining from untyped to typed namespace', async () => {
            const index = new index_1.Index({ name: 'index-name' }, config);
        ...
        test('inherits host url when specified', () => {
            ...
            expect(vectorOperationsProvider_1.VectorOperationsProvider).toHaveBeenCalledWith(config, 'index-name', customHost, undefined);
        });
    });
});
