...
let serverlessIndexName, pinecone;
describe('configure index', () => {
    beforeAll(async () => {
        pinecone = new index_1.Pinecone();
        serverlessIndexName = (0, test_helpers_1.randomName)('serverless-configure');
    ...
    describe('serverless index', () => {
        test('enable and disable deletionProtection', async () => {
            ...
            await (0, test_helpers_1.waitUntilIndexReady)(serverlessIndexName);
