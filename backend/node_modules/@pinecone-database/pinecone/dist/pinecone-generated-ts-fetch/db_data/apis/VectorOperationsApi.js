...
class VectorOperationsApi extends runtime.BaseAPI {
    ...
    async deleteVectorsRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
            throw new runtime.RequiredError('xPineconeApiVersion', 'Required parameter requestParameters.xPineconeApiVersion was null or undefined when calling deleteVectors.');
        }
    ...
    async describeIndexStatsRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
            throw new runtime.RequiredError('xPineconeApiVersion', 'Required parameter requestParameters.xPineconeApiVersion was null or undefined when calling describeIndexStats.');
        }
    ...
    async fetchVectorsRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
            throw new runtime.RequiredError('xPineconeApiVersion', 'Required parameter requestParameters.xPineconeApiVersion was null or undefined when calling fetchVectors.');
        }
    ...
    async fetchVectorsByMetadataRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
            throw new runtime.RequiredError('xPineconeApiVersion', 'Required parameter requestParameters.xPineconeApiVersion was null or undefined when calling fetchVectorsByMetadata.');
        }
        if (requestParameters.fetchByMetadataRequest === null || requestParameters.fetchByMetadataRequest === undefined) {
            throw new runtime.RequiredError('fetchByMetadataRequest', 'Required parameter requestParameters.fetchByMetadataRequest was null or undefined when calling fetchVectorsByMetadata.');
        }
        const queryParameters = {};
        const headerParameters = {};
        headerParameters['Content-Type'] = 'application/json';
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: (0, index_1.FetchByMetadataRequestToJSON)(requestParameters.fetchByMetadataRequest),
        }, initOverrides);
        return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.FetchByMetadataResponseFromJSON)(jsonValue));
    }
    /**
     * Look up and return vectors by metadata filter from a single namespace. The returned vectors include the vector data and/or metadata. For guidance and examples, see [Fetch data](https://docs.pinecone.io/guides/manage-data/fetch-data).
     * Fetch vectors by metadata
    ...
    async listVectorsRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
            throw new runtime.RequiredError('xPineconeApiVersion', 'Required parameter requestParameters.xPineconeApiVersion was null or undefined when calling listVectors.');
        }
        const queryParameters = {};
    ...
    async queryVectorsRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
            throw new runtime.RequiredError('xPineconeApiVersion', 'Required parameter requestParameters.xPineconeApiVersion was null or undefined when calling queryVectors.');
        }
    ...
    async searchRecordsNamespaceRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
            throw new runtime.RequiredError('xPineconeApiVersion', 'Required parameter requestParameters.xPineconeApiVersion was null or undefined when calling searchRecordsNamespace.');
        }
    ...
    async updateVectorRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
            throw new runtime.RequiredError('xPineconeApiVersion', 'Required parameter requestParameters.xPineconeApiVersion was null or undefined when calling updateVector.');
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.UpdateResponseFromJSON)(jsonValue));
    }
    /**
     * Update a vector in a namespace. If a value is included, it will overwrite the previous value. If a `set_metadata` is included, the values of the fields specified in it will be added or overwrite the previous value.  For guidance and examples, see [Update data](https://docs.pinecone.io/guides/manage-data/update-data).
     * Update a vector
    ...
    async upsertRecordsNamespaceRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
            throw new runtime.RequiredError('xPineconeApiVersion', 'Required parameter requestParameters.xPineconeApiVersion was null or undefined when calling upsertRecordsNamespace.');
        }
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
    ...
    async upsertVectorsRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
            throw new runtime.RequiredError('xPineconeApiVersion', 'Required parameter requestParameters.xPineconeApiVersion was null or undefined when calling upsertVectors.');
        }
