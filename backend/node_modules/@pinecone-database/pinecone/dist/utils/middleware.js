...
exports.createMiddlewareArray = void 0;
    ...
    return [
        ...
        // Error handling middleware - converts ResponseErrors to proper Pinecone error types
        {
            onError: async (context) => {
                ...
                if (context.error instanceof errors_1.PineconeMaxRetriesExceededError) {
                    throw context.error;
                }
...
exports.createMiddlewareArray = createMiddlewareArray;
