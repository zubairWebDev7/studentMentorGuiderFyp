...
function ContextOptionsModelFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'multimodal': !(0, runtime_1.exists)(json, 'multimodal') ? undefined : json['multimodal'],
        'includeBinaryContent': !(0, runtime_1.exists)(json, 'include_binary_content') ? undefined : json['include_binary_content'],
    };
}
