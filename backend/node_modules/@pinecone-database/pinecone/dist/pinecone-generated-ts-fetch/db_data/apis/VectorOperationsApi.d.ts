...
import type { DeleteRequest, DescribeIndexStatsRequest, FetchByMetadataRequest, FetchByMetadataResponse, FetchResponse, IndexDescription, ListResponse, QueryRequest, QueryResponse, SearchRecordsRequest, SearchRecordsResponse, UpdateRequest, UpdateResponse, UpsertRecord, UpsertRequest, UpsertResponse } from '../models/index';
...
export interface FetchVectorsByMetadataRequest {
    xPineconeApiVersion: string;
    fetchByMetadataRequest: FetchByMetadataRequest;
}
...
export declare class VectorOperationsApi extends runtime.BaseAPI {
     ...
     */
    fetchVectorsByMetadataRaw(requestParameters: FetchVectorsByMetadataRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FetchByMetadataResponse>>;
    /**
     * Look up and return vectors by metadata filter from a single namespace. The returned vectors include the vector data and/or metadata. For guidance and examples, see [Fetch data](https://docs.pinecone.io/guides/manage-data/fetch-data).
     * Fetch vectors by metadata
     */
    fetchVectorsByMetadata(requestParameters: FetchVectorsByMetadataRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FetchByMetadataResponse>;
    /**
     ...
     * Update a vector
     */
    updateVectorRaw(requestParameters: UpdateVectorRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UpdateResponse>>;
    /**
     * Update a vector in a namespace. If a value is included, it will overwrite the previous value. If a `set_metadata` is included, the values of the fields specified in it will be added or overwrite the previous value.  For guidance and examples, see [Update data](https://docs.pinecone.io/guides/manage-data/update-data).
     * Update a vector
     */
    updateVector(requestParameters: UpdateVectorRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UpdateResponse>;
    /**
