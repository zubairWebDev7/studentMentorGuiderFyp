...
class ManageAssistantsApi extends runtime.BaseAPI {
    ...
    async createAssistantRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
            throw new runtime.RequiredError('xPineconeApiVersion', 'Required parameter requestParameters.xPineconeApiVersion was null or undefined when calling createAssistant.');
        }
    ...
    async deleteAssistantRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
            throw new runtime.RequiredError('xPineconeApiVersion', 'Required parameter requestParameters.xPineconeApiVersion was null or undefined when calling deleteAssistant.');
        }
    ...
    async getAssistantRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
            throw new runtime.RequiredError('xPineconeApiVersion', 'Required parameter requestParameters.xPineconeApiVersion was null or undefined when calling getAssistant.');
        }
        if (requestParameters.assistantName === null || requestParameters.assistantName === undefined) {
    ...
    async listAssistantsRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
            throw new runtime.RequiredError('xPineconeApiVersion', 'Required parameter requestParameters.xPineconeApiVersion was null or undefined when calling listAssistants.');
        }
        const queryParameters = {};
        const headerParameters = {};
        if (requestParameters.xPineconeApiVersion !== undefined && requestParameters.xPineconeApiVersion !== null) {
    ...
    async updateAssistantRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
            throw new runtime.RequiredError('xPineconeApiVersion', 'Required parameter requestParameters.xPineconeApiVersion was null or undefined when calling updateAssistant.');
        }
        if (requestParameters.assistantName === null || requestParameters.assistantName === undefined) {
