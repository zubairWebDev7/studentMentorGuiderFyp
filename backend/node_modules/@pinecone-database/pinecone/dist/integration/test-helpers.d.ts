...
export declare const randomName: (name: string) => string;
...
export declare const waitUntilIndexReady: (indexName: string) => Promise<void>;
export declare const waitUntilAssistantReady: (assistantName: string) => Promise<void>;
export declare const waitUntilAssistantFileReady: (assistantName: string, fileId: string) => Promise<void>;
