...
export interface MetadataSchema {
     ...
     */
    fields: {
        [key: string]: MetadataSchemaFieldsValue;
    };
}
/**
 * Check if a given object implements the MetadataSchema interface.
 */
export declare function instanceOfMetadataSchema(value: object): boolean;
export declare function MetadataSchemaFromJSON(json: any): MetadataSchema;
export declare function MetadataSchemaFromJSONTyped(json: any, ignoreDiscriminator: boolean): MetadataSchema;
export declare function MetadataSchemaToJSON(value?: MetadataSchema | null): any;
