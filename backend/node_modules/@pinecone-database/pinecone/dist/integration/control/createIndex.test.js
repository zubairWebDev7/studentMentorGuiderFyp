    ...
    describe('serverless index tests', () => {
        describe('happy path', () => {
            test('create dense index', async () => {
                const indexName = (0, test_helpers_1.randomName)('serverless-create');
                ...
                if ('serverless' in description.spec) {
                    expect(description.spec.serverless?.readCapacity.mode).toEqual('OnDemand');
                }
                await pinecone.deleteIndex(indexName);
            });
            test('create serverless index with Dedicated read capacity', async () => {
                const indexName = (0, test_helpers_1.randomName)('svrlss-dedicated');
                await pinecone.createIndex({
                    name: indexName,
                    dimension: 5,
                    spec: {
            ...
            test('create sparse index', async () => {
                const indexName = (0, test_helpers_1.randomName)('svrlss-sparse-create');
                await pinecone.createIndex({
                    name: indexName,
                    vectorType: 'sparse',
                    spec: {
        ...
        describe('error cases', () => {
            ...
            test('create sparse index with invalid metric', async () => {
                try {
                    const indexName = (0, test_helpers_1.randomName)('sparse-error');
                    await pinecone.createIndex({
                        name: indexName,
                        metric: 'cosine',
                        vectorType: 'sparse',
    ...
    describe('pod index tests', () => {
        describe('happy path', () => {
            test('create pod index', async () => {
                const indexName = (0, test_helpers_1.randomName)('test-pod-create');
                await pinecone.createIndex({
                    name: indexName,
                    dimension: 5,
                    metric: 'cosine',
        ...
        describe('error cases', () => {
            test('create from non-existent collection', async () => {
                const indexName = (0, test_helpers_1.randomName)('collection-error');
                try {
                    await pinecone.createIndex({
                        name: indexName,
                        dimension: 5,
