...
const chatStream_1 = require("../chatStream");
...
const buildMockFetchResponse = (body) => mockFetch.mockResolvedValue({
    ok: true,
    body: body,
});
describe('chatStream', () => {
    ...
    test('sends basic chat request with correct body structure', async () => {
        const streamFn = (0, chatStream_1.chatStream)(mockAssistantName, mockApiProvider, mockConfig);
        const options = {
            messages: [{ role: 'user', content: 'Hello' }],
        };
        await streamFn(options);
        expect(mockFetch).toHaveBeenCalledWith('https://prod-1-data.ke.pinecone.io/assistant/chat/test-assistant', expect.objectContaining({
            method: 'POST',
